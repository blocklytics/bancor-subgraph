...
export class ConverterRegistry__tokenTableResult {
  value0: boolean;
  value1: BigInt;
...
export class ConverterRegistry extends SmartContract {
  static bind(address: Address): ConverterRegistry {
    return new ConverterRegistry("ConverterRegistry", address);
  }

  tokenTable(param0: Address): ConverterRegistry__tokenTableResult {
    let result = super.call("tokenTable", [EthereumValue.fromAddress(param0)]);

    return new ConverterRegistry__tokenTableResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  try_tokenTable(
    param0: Address
  ): CallResult<ConverterRegistry__tokenTableResult> {
    ...
    return CallResult.fromValue(
      new ConverterRegistry__tokenTableResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
